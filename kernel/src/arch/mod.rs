...
pub use imp::{
    ...
    cpu_feature_names, cpu_report, cpu_topology_bits, cycles, decode_syscall, discover,
    ...
    msi_irq_count, msi_route, msi_target, net_irq_enabled, net_irq_pending, paging_activate,
