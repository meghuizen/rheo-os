...
pub use imp::{
    ...
    enable_uart_rx_irq, enable_virtio_net_irq, enter_user_first, exit, has_hwrng, hwrng_name,
    hwrng_u64, idle_wait, net_irq_enabled, net_irq_pending, paging_activate,
    paging_activate_kernel, paging_for_each_user_leaf, paging_kernel_init, paging_map,
    paging_map_frame, paging_new_root, paging_protect, paging_unmap_frame, pci_cfg_read32,
