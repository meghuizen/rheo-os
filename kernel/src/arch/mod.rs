...
pub use imp::{
    ...
    idle_wait, irq_ready_this_cpu, irq_window, mmio_map_window, msi_irq_count, msi_route,
    msi_target, net_irq_enabled, net_irq_pending, paging_activate, paging_activate_kernel,
    paging_cow_at, paging_cow_clear, paging_cow_protect_user, paging_for_each_user_leaf,
    paging_kernel_init, paging_map, paging_map_frame, paging_mapped, paging_new_root,
    paging_protect, paging_unmap_frame, paging_unmapped_span, pci_cfg_read32, pci_cfg_write32,
