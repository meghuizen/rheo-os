...
static DEMO: &[u8] = include_bytes!(concat!(
    ...
    "/../target/x86_64-unknown-none/release/netcore-demo"
));
#[cfg(target_arch = "aarch64")]
static DEMO: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../target/aarch64-unknown-none-softfloat/release/netcore-demo"
));
#[cfg(target_arch = "riscv64")]
static DEMO: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../target/riscv64gc-unknown-none-elf/release/netcore-demo"
));
...
extern "C" fn kernel_main() -> ! {
    ...
    let entry = load::load_elf(DEMO, &mut aspace).expect("load netcore-demo ELF");
